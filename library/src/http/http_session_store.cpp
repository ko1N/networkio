...
std::shared_ptr<session> session_store::get(connection &conn) {
...
std::string session_store::generate_session_id() {
  // TODO: implement me
  /*
...
sha1(Botan::HashFunction::create("SHA-1")); sha1->update(buffer,
sizeof(buffer)); return Botan::hex_encode(sha1->final());
  */
  return "implement_me";
}
